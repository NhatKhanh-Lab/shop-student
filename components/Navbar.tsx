          ...
          <div className="flex items-center gap-4">
            ...
            {isAuthenticated && user ? (
              <div className="relative group h-full flex items-center">
                ...
                <div className="absolute right-0 top-full w-48 pt-2 invisible opacity-0 translate-y-2 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200 origin-top-right z-[100]">
