          ...
          <div className="flex items-center gap-4">
            ...
            {isAuthenticated && user ? (
              <div className="relative group h-full flex items-center">
                ...
                <div className="absolute right-0 top-full w-48 pt-2 invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-200 z-[100]">
                  <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden translate-y-2 group-hover:translate-y-0 transition-transform duration-200 origin-top-right">
                    <div className="py-2">
